...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double wheelBase = Units.inchesToMeters(27); //TODO: This must be tuned to specific robot
        ...
        public static final double angleContinuousCurrentLimit = 25;
        public static final double anglePeakCurrentLimit = 40;
        public static final double anglePeakCurrentDuration = 0.1;
        public static final boolean angleEnableCurrentLimit = true;

        public static final double driveContinuousCurrentLimit = 40;
        public static final double drivePeakCurrentLimit = 60;
