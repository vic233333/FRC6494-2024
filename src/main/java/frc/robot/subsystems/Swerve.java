...
public class Swerve extends SubsystemBase {
    ...
    public Rotation2d getYaw() {
        StatusSignal<Double> the_Yaw_Status_Signal_Object =gyro.getYaw();
        return (Constants.Swerve.invertGyro) ? Rotation2d.fromDegrees(360 - the_Yaw_Status_Signal_Object.getValueAsDouble()) : Rotation2d.fromDegrees(the_Yaw_Status_Signal_Object.getValueAsDouble());
    }
